...
function buildplot(id) {
    d3.json("data/samples.json").then((data) => {
        ...
        // Loop thorugh the arrays of otu_ids,sample_values and otu_labels 
        ...
        // creating trace for Horizontal bar chart, y axis data for OTU_IDs is converted in the desired format 
        var trace1 = {
